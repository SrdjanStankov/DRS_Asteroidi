...
from PyQt5.QtWidgets import QGraphicsItem, QMainWindow, QGraphicsScene, QGraphicsView, QGraphicsLineItem, QApplication
...
class MyGraphicScene(QMainWindow):
    ...
    def sceneConfig(self):
        self.Scene.setBackgroundBrush(QBrush(QPixmap("5_Pluto.jpg")))
